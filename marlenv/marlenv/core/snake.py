...
# Giữ nguyên màu gốc cho thân
_color_wheel = [(104, 255, 0), (255, 191, 0), (255, 0, 92), (0, 111, 255)]

# Tạo màu nhạt hơn cho head bằng cách tăng độ sáng
_head_color_wheel = [
    (min(255, int(r * 2.0)), min(255, int(g * 2.0)), min(255, int(b * 2.0)))
    for (r, g, b) in _color_wheel
]
...
CellColors = {
    ...
    Cell.HEAD.value: _head_color_wheel,  # màu đầu sáng hơn
